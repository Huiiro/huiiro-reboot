...
INSERT INTO "public"."sys_menu" VALUES (6, 1, 1, '岗位管理', 'system:post', 'Management', '/system/post', 'system/post/Index', 3, '1', '1', NULL, NULL, NULL, NULL, 'admin', '2023-12-06 20:06:57.605597');
...
INSERT INTO "public"."sys_menu" VALUES (7, 1, 1, '部门管理', 'system:dept', 'DataBoard', '/system/dept', 'system/dept/Index', 4, '1', '1', NULL, NULL, NULL, NULL, 'admin', '2023-11-28 17:19:19.691728');
...
INSERT INTO "public"."sys_user" VALUES (1, 1, 'admin', 'huii', '$2a$10$Tt68.t/JevKsB7rKG/12bOudxvDz9LHOHlEII/.2uPzsdSig9YEOe', '19923352758', '1659009445@qq.com', '1', 'http://127.0.0.1:8080/oss/local?module=avatar&fileName=202401241441e7cfdc292522.jpg', '0:0:0:0:0:0:0:1', '2024-02-21 04:12:39.2392', '0', '1', NULL, NULL, '2023-11-29 16:09:15', NULL, '2024-02-21 04:12:39.2417');
...
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."gen_column_id_seq"', 187, true);

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."gen_table_id_seq"', 28, true);
...
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."sys_log_login_id_seq"', 82, true);
...
SELECT setval('"public"."sys_log_op_id_seq"', 936, true);
